      ...
      <div className="max-w-sm sm:max-w-md bg-white dark:bg-gray-200 border-2 border-gray-300 p-6 rounded-md tracking-wide shadow-xl">
        <div id="header" className="flex items-center mb-4">
          ...
          <div id="header-text" className="leading-5 ml-6 sm">
            ...
            <div className='flex'>
              <a href = {web} target="_blank" rel="noreferrer" id="job" className= "flex hover:text-yellow-500 text-lg dark:text-yellow-500 font-light text-gray-500">
                {company} 
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-3 mt-2 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
