        ...
        <div className="mt-8 md:mt-0 md:space-x-10 md:grid grid-cols-3 justify-center md:py-20">
          ...
          <div className="mt-8 md:mt-0 lg:justify-end col-span-2">
            <h1 className="text-4xl text-gray-800 text-center md:text-left font-bold mb-6 dark:text-gray-200">
              Hi, I am Rafael, Software Developer
            </h1>
            <p className="text-xl text-gray-800 text-center md:text-left dark:text-gray-200">
                Specialized in software engineering and experienced in developing solutions and algorythm optimizations. Experience working with agile methodologies.  Javascript Software Developer FullStack NodeJs and ReactJs.
            </p>
            <button>
            <a href={'/cv.pdf'} target={"_blank"} rel="noreferrer" className="block mt-8 mx-auto md:mx-0 text-lg py-3 px-6 text-red-50 font-semibold rounded bg-yellow-500 shadow-xl hover:bg-yellow-600 transition-all duration-500 ease-in-out">
              Download Resume
            </a>
            </button>
          </div>
